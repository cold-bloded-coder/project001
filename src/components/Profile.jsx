...
function Profile() {
  return (
    <div className='group md:rounded-[10px] md:border flex md:px-[18px] md:py-[5px] justify-between items-center self-end md:scale-90 md:hover:bg-primary md:hover:text-white md:hover:scale-100 ease-in-out duration-300 hover:cursor-pointer'>
